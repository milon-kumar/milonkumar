                    ...
                    <div class="card">
                        ...
                        <div class="comment-widgets scrollable">
                            ...
                            <div class="d-flex flex-row comment-row mt-0">
                                <div class="p-2">
                                    <img
                                        src="{{asset('/')}}assets/backend/images/users/1.jpg"
                                        alt="user"
                                        width="50"
                        ...
                        type setting industry.
                            ...
                            <div class="d-flex flex-row comment-row">
                                <div class="p-2">
                                    <img
                                        src="{{asset('/')}}assets/backend/images/users/4.jpg"
                                        alt="user"
                                        width="50"
                                        class="rounded-circle"
                                    />
                        ...
                        type setting industry.
                            ...
                            <div class="d-flex flex-row comment-row">
                                <div class="p-2">
                                    <img
                                        src="{{asset('/')}}assets/backend/images/users/5.jpg"
                                        alt="user"
                                        width="50"
                                        class="rounded-circle"
                                    />
                                        ...
                                        <ul class="list-style-none assignedto">
                                            ...
                                            <li class="assignee">
                                                <img
                                                    class="rounded-circle"
                                                    width="40"
                                                    src="{{asset('/')}}assets/backend/images/users/2.jpg"
                                                    alt="user"
                                                    data-toggle="tooltip"
                                                    data-placement="top"
                                                    title=""
                                            ...
                                            <li class="assignee">
                                                <img
                                                    class="rounded-circle"
                                                    width="40"
                                                    src="{{asset('/')}}assets/backend/images/users/3.jpg"
                                                    alt="user"
                                                    data-toggle="tooltip"
                                                    data-placement="top"
                                                    title=""
                        ...
                        <div class="card-body">
                            ...
                            <div class="chat-box scrollable" style="height: 475px">
                                ...
                                <ul class="chat-list">
                                    ...
                                    <li class="chat-item">
                                        <div class="chat-img">
                                            <img src="{{asset('/')}}assets/backend/images/users/3.jpg" alt="user" />
                                        </div>
                                        <div class="chat-content">
                        ...
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane active" id="home" role="tabpanel">
                                <div class="p-20">
                                    ...
                                    <img
                                        src="{{asset('/')}}assets/backend/images/background/img4.jpg"
                                        class="img-fluid"
                                    />
                                </div>
                            </div>

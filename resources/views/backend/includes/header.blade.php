        ...
        <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="{{route('backend.home')}}">
                ...
                <b class="logo-icon ps-2">
                    ...
                    <!-- Dark Logo icon -->
                    <img
                        src="{{asset('/')}}assets/backend/images/logo-icon.png"
                        alt="homepage"
                        class="light-logo"
                        width="25"
                    />
                ...
                <!-- dark Logo text -->
                <img
                    src="{{asset('/')}}assets/backend/images/logo-text.png"
                    alt="homepage"
                    class="light-logo"
                />
              </span>
                ...
                <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
                <!-- Dark Logo icon -->
            <!-- <img src="{{asset('/')}}assets/backend/images/logo-text.png" alt="homepage" class="light-logo" /> -->
